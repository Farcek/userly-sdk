...
var debug = require('debug')('userly-sdk:aclmanager');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, http.get(option.baseUrl + "/acl-roles", { header: header, timeout: option.requestTimeout })];
                case 1:
                    result = _a.sent();
...
function setACL(option, accessTable) {
    ...
    return http.post(option.baseUrl + "/acl-roles", { header: header, timeout: option.requestTimeout }, { accessTable: accessTable });
}
exports.setACL = setACL;
var AclManager = /** @class */ (function () {
    function AclManager(baseUrl, token, requestTimeout) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.reloadTable()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    AclManager.prototype.reloadTable = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, getACL({ baseUrl: this.baseUrl, requestTimeout: this.requestTimeout, token: this.token.currentToken })];
                    case 1:
                        _a._table = _b.sent();
